...
-- QUESTION 3
UPDATE petEvent SET eventtype = '5 kittens, 3 female, 2 male' WHERE petname = 'Fluffy' AND eventtype = 'litter';
...
-- QUESTION 6
DELETE pets.*,events.* FROM petPet as pets,petEvent as events WHERE pets.petname = events.petname AND pets.petname = 'Fluffy'; 
